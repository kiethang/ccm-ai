...
with st.sidebar:
    ...
    st.text_input("User", value="sql12754261", key="User")
    st.text_input("Password", type="password", value="pDdJqzFl3b", key="Password")
    st.text_input("Database", value="sql12754261", key="Database")
